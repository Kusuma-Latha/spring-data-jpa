...
public class EmployeeController {
	...
	@PutMapping("/updateEmployee/{empId}/{empName}/{deptName}/{managerName}")
	public String updateEmolyeeDetails(@PathVariable Long empId, @PathVariable String empName,
			@PathVariable String deptName, @PathVariable String managerName) {
		employeeService.updateEmolyeeDetails(empId, empName, deptName, managerName);
